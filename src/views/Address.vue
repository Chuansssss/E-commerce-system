<template>
        ...
        <div class="container">
          <div class="checkout-addr">
            ...
            <div class="addr-list-wrap">
              <div class="addr-list">
                <ul>
                  <li v-for="(item, index) in addressListFilter" v-bind:class="{'check': checkedIndex == index}" @click="checkedIndex = index; selectedAddressId = item.addressId">
                    <dl>
                      <dt>{{item.userName}}</dt>
    ...
    <modal :mdShow="isMdShow" @close="closeModal">
      <span slot="message">R u sure u want to delete this address?</span>
      <div slot="btnGroup">
